@testset "NelsonSiegelSvensson" begin
    ...
    @testset "NelsonSiegel" begin
        ...
        @testset "EURAAA_20191111" begin
            ...
            ns = Yields.NelsonSiegel(euraaa_zeros, euraaa_maturities)
        ...
        @testset "pack" begin
            ...
            ns = Yields.NelsonSiegel(pack_yields, pack_maturities)
            @testset "parameter: $param" for param in [:β₀, :β₁, :β₂, :τ₁]
                @test getfield(ns, param) ≈ getfield(ns_param, param)
            end
    ...
    @testset "NelsonSiegelSvensson" begin
        ...
        @testset "EURAAA_20191111" begin
            ...
            nss = Yields.NelsonSiegelSvensson(euraaa_zeros, euraaa_maturities)
        ...
        @testset "EURAAA_20191111 w parms given" begin
            ...
            @testset "Curve Interface" begin
                ...
                @test Yields.par(c,30) ≈ Yields.Continuous(last(euraaa_pars)) atol = 0.0001 
                @test Yields.forward(c,30) ≈ Yields.Continuous(last(euraaa_pars)) atol = 0.0001 
                @test Yields.forward(c,0,30) ≈ Yields.Continuous(last(euraaa_pars)) atol = 0.0001 
            end
        end
    end
